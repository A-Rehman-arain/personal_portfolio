...
const Contact: React.FC = () => {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("access_key", "53f3eb9f-7dd0-4a6c-b5a8-d2cd0d3e3c43"); // Replace with your Web3Forms API Key
  ...
  return (
    <div id="Contact" style={{ backgroundColor: "#FFFFF" }}>
            ...
            <div className="bg-white relative flex py-6 rounded shadow-md w-full flex-wrap overflow-hidden">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a href="mailto:mahamsaif2005@gmail.com" className="text-indigo-500 leading-relaxed">
                  rehmanarain481@gmail.com
                </a>
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p className="leading-relaxed">+92 3103866174</p>
              </div>
            </div>
          </div>
          <div
